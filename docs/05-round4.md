...
## Algorithmic side: projected 130K XIRECs, delivered 19.7K XIRECs
...
In backtesting against the available day's data, this looked excellent: projected ~130K XIRECs. **It delivered 19,664 XIRECs.**
...
- On the day we tuned against, the underlying drifted down monotonically (−63 XIRECs over the window). The deep-ITM short calls profited as the options tracked intrinsic value down.
- On the **live scoring day**, the underlying barely moved net (−9 XIRECs) but **spiked intraday** to near our stop-loss levels.
- The short option book ate massive intraday mark-to-market drawdowns (one strike peaked at +7,633 XIRECs then troughed at −20,991 XIRECs before recovering to −5,781 XIRECs).
...
That strike is VEV_4000, the real, tick-by-tick mark-to-market PnL from the actual live-scored submission (`PIPELINE/data/r4/Round 4 Full 10k tick run/545097/545097.json`, total algo profit 19,663.66 XIRECs, matching the 19,664 XIRECs reported above). Two full round trips through a ~28K XIRECs swing before the position ever nets out: this is what "the underlying spiked intraday" looks like in practice, not just in prose.
...
Optimal payout: **177,980.** We scored **23,566**, leaving ~155K XIRECs on the table.
...
2. **A direction error** on the knock-out put (our submitted side disagreed with our own rationale text, a transcription mistake that alone cost ~18K XIRECs).
...
R4 hurt. But it produced the discipline that made our R5 manual (+89K XIRECs, rank 411) and our analysis of the R5 algo candidates genuinely rigorous.
